...
$.fn.serializeObject=function(){var o={};var a=this.serializeArray();$.each(a,function(){var name=this.name;var isArr=false;var value=this.value||'';if(this.name.substr(-2)==='[]'){name=this.name.substr(0,this.name.length-2);isArr=true}if(o[name]){if(!o[name].push){o[name]=[o[name]]}o[name].push(value)}else{if(isArr){o[name]=[value]}else{o[name]=value}}});return o};
